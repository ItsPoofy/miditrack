...
export declare function updateSSGVolume(host: MidiConverter, keyPrefix: string, channel: number, data: number, currentTime: number, activeNotes: ActiveNoteMap, cmdIndex?: number, chip?: string, instance?: number): void;
export declare function updateSSGMixer(host: MidiConverter, keyPrefix: string, data: number, currentTime: number, activeNotes: ActiveNoteMap, cmdIndex?: number, chip?: string, instance?: number): void;
export declare function syncSSGToneState(host: MidiConverter, keyPrefix: string, channel: number, currentTime: number, activeNotes: ActiveNoteMap, cmdIndex?: number, chip?: string, instance?: number): void;
