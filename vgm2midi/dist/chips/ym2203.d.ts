...
export declare function handleYM2203KeyWrite(host: MidiConverter, context: OPNCh3Context, data: number, register: number, currentTime: number, activeNotes: ActiveNoteMap, cmdIndex?: number): boolean;
