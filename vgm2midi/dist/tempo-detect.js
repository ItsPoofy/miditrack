...
exports.detectTempoFromOnsets = detectTempoFromOnsets;
function detectTempoFromOnsets(onsetSampleTimes, sampleRate = 44100) {
    ...
    function scoreBpm(candidateBpm) {
